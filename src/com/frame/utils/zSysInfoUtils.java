...
public class zSysInfoUtils {
	...
	public static String readTelephoneSerialNum(Context con) {
		...
		return telephoneSerialNumber != null ? telephoneSerialNumber
				: "000000000000000";
	}
	 ...
	 * @return width 屏幕宽度像素
	 */
	public static int getDisplayWidth(Activity con) {
		return getDisplayMetrics(con).widthPixels;
	}

	/**
	 * 获取屏幕高度
	 * 
	 * @return height 屏幕高度像素
	 */
	public static int getDisplayheight(Activity con) {
		return getDisplayMetrics(con).heightPixels;
	}
